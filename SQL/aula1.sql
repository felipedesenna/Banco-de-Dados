...
/*ORGANIZAR FISICAMENTE E LOGICAMENTE UM BANDO DE DADOS
...
/*IFNULL*/
SELECT A.NOME, ISNULL(T.TIPO, 'SEM') AS "TIPO", ISNULL(T.NUMERO, 'NUMERO') AS "TELEFONE", E.BAIRRO, E.UF
FROM ALUNO A
LEFT JOIN TELEFONE T
ON A.IDALUNO = T.ID_ALUNO
INNER JOIN ENDERECO E
...
BEGIN
	...
	INSERT INTO HIST_SALARIO
	(IDEMPREGADO,ANTIGOSAL,NOVOSAL,DATA,NOMEEMPREGADO)
...
UPDATE EMPREGADO SET SALARIO = SALARIO * 1.5
GO
...
TRANSACTION SQL -> LINGUAGEM QUE O SQL SERVER TABALHA*/
DECLARE @SAIDA INT
...
ANÔNIMOS. BLOCOS ANÔNIMOS NÃO RECEBEM NOME, POIS
NÃO SÃO SALVOS NO BANCO. CRIAMOS BLOCOS ANÔNIMOS QUANDO
